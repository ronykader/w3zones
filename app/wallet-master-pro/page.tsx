      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-white to-gray-50">
        <div className="container">
          ...
          >
            ...
            <h1 className="section-title mt-4">Wallet Master Pro</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Wallet Master Pro is a comprehensive financial management
                solution designed to help businesses and individuals take
                control of their finances. With powerful features and an
                intuitive interface, managing your money has never been easier.
              </p>
